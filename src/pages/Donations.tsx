...
function Donations() {
  ...
  useEffect(() => {
    ...
    script.setAttribute('data-form', config.cognito.forms.donations);
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
                {currentLang === 'en' ? 'Make a Donation' : 'Hacer una Donación'}
              </h1>
              <p className="text-gray-600 text-lg">
                {currentLang === 'en'
                  ? 'Your generosity helps us support local communities'
                  : 'Su generosidad nos ayuda a apoyar a las comunidades locales'}
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-cream-300/50 p-6 md:p-8">
              <div id="form1" className="min-h-[400px] md:min-h-[600px]"></div>
            </div>
          </div>
        </div>
      </main>
