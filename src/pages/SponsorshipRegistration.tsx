...
function SponsorshipRegistration() {
  ...
  useEffect(() => {
    ...
    script.setAttribute('data-form', config.cognito.forms.sponsorshipRegistration);
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">
                {currentLang === 'en'
                  ? 'Complete your sponsorship registration and support our mission'
                  : 'Complete su registro de patrocinio y apoye nuestra misión'}
              </p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-cream-300/50 p-6 md:p-8">
              <div id="form3" className="min-h-[400px] md:min-h-[600px]"></div>
            </div>
          </div>
        </div>
      </main>
